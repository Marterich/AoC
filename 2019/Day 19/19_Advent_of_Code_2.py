		...
		while f:
			...
			if computer(x,y) == 1:
				...
				if (a == 100):
					...
					# print(x,y)
					b = 0
					# print(arealist[x][y-9])
					for z in range(len(arealist)-1):
						# print(z,y-1)
						# print(arealist[z][y])
						try:
							if arealist[z][y] == "#":
							...
							None
					if b == 100:
						print("100x100 Cube fits at Y{0} X{1}".format(x, y))
						return(arealist)
					else: 
						print("Area Y{0} X{1} has only {2} fields".format(x,y, a*b))

			elif x < 3 and y > 10:
				break
			elif computer(x,y) == 0 and a >= 1:
				arealist[x][y] = "."
				f = False
				break
			y += 1
